...
class User(AbstractBaseUser):
    ...
    pfp =                           models.ImageField(upload_to=upload_location_pfp, blank=False)
    id_card =                       models.ImageField(upload_to=upload_location_id_card, blank=False)
    ...
    phone_num =                     PhoneNumberField(null=False, blank=True, verbose_name="Phone Number")
