...
urlpatterns = [
    ...
    path('approve-money-transer/<sender>/<recipient>/<amount_to_send>/<token>', views.approve_send_money_request, name='approve_send_money'),
    path('reject-money-transer/<recipient>/<amount_to_send>/<token>', views.reject_send_money_request, name='reject_send_money'),
